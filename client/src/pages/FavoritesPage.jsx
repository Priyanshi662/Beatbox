...
import ArtistSong from "../components/ArtistSong.jsx";
import { playTrack, setTrackList } from "../redux/slices/playerSlice.jsx";
	...
	return (
		<Box
			...
			<Flex direction="column" gap={4} mt={4}>
				{favorites?.map((song) => (
					<ArtistSong key={song._id} song={song} handlePlay={onPlay} />
				))}
			</Flex>
